...
Fixpoint count (v:nat) (s:bag) : nat :=
  match s with
  | nil => O
  | h :: t =>  match andb (leb h v) (leb v h) with
               | true => S ( count v t)
               | false => count v t
               end
  end.
...
Proof.
  intros l. induction l as [|n li IHl'].
  - simpl. reflexivity.
  - simpl. induction n as [O | n' IHl1'].
    { - simpl. rewrite -> IHl'. reflexivity. }
...
Theorem rev_injective: forall (l1 l2 : natlist),
    rev l1 = rev l2 -> l1 = l2.
Proof.
  intros l1 l2 H. induction l1 as [|n l IHl].
...
Inductive baz : Type :=
  | Baz1 : baz -> baz
  | Baz2 : baz -> bool -> baz.
(* No elements. Could not construct from empty. so no constructor could be applied to construct. *)
